	...
	}{
		{
			...
			mockFn: func(args args) {
				mock.ExpectQuery(`SELECT \* FROM "users" .+`).
					...
					WillReturnRows(sqlmock.NewRows([]string{"id", "created_at", "updated_at", "email", "username", "password", "created_by", "updated_by"}).AddRow(1, now, now, "test@gmail.com", "username", "password", "test@gmail.com", "test@gmail.com"))
			},
		},
		{
			name: "failed",
